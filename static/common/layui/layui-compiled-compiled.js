...
;!function (win) {
  ...
  Lay.fn.onevent = function (modName, events, callback) {
    ...
    config.event[modName + '.' + events] ? config.event[modName + '.' + events].push(callback) : config.event[modName + '.' + events] = [callback];
    return this;
  };
...
//# sourceMappingURL=layui-compiled-compiled.js.map